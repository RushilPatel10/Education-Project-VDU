...
import { useParams, useNavigate, Link } from 'react-router-dom'; // For getting courseId from URL and navigating
...
const AddCourse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let response;
      if (courseId) {
        response = await axios.put(`${API_BASE_URL}/api/courses/edit/${courseId}`, courseData, config);
      } else {
        response = await axios.post(`${API_BASE_URL}/api/courses/create`, courseData, config);
      }
      if (response.data) {
        ...
        <div className="page-header">
          <div className="page-block">
            <ul className="breadcrumb">
              <li className="breadcrumb-item"><Link to={getHomePath()}>Home</Link></li>
              <li className="breadcrumb-item"><span className="text-muted">Forms</span></li>
