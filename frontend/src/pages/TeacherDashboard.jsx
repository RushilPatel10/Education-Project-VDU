  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/api/teacher/assigned-courses`, {
  ...
  const handleGradeSubmit = async (assignmentId) => {
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/api/teacher/assign-grade/${assignmentId}`,
                ...
                <tbody>
                  {course.submissions.map((submission) => (
                    <tr key={submission._id}>
                      ...
                      <td>
                        <a href={`${API_BASE_URL}/${submission.filePath}`} target="_blank" rel="noopener noreferrer">View Assignment</a>
                      </td>
