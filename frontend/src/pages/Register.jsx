  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let msg =
        ...
        null;
      if (!msg && (error.code === 'ERR_NETWORK' || error.message === 'Network Error')) {
        msg =
          'Cannot reach the API. In development, keep `npm start` running and ensure package.json `proxy` matches your backend (or set REACT_APP_API_URL).';
      }
      setError(msg || error.message || 'An error occurred. Please try again.');
    }
  };
